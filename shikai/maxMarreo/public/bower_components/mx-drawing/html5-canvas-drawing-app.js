	...
	var canvas,
		...
		createUserEvents = function () {
			...
			var press = function (e) {
				...
				drag = function (e) {
					if (paint) {
						addClick(e.offsetX - this.offsetLeft, e.offsetY - this.offsetTop, true);
						redraw();
					}
		...
		init = function (container) {
			...
			crayonImage.src = "bower_components/mx-drawing/images/crayon-outline.png";

			markerImage.onload = resourceLoaded;
			markerImage.src = "bower_components/mx-drawing/images/marker-outline.png";

			eraserImage.onload = resourceLoaded;
			eraserImage.src = "bower_components/mx-drawing/images/eraser-outline.png";

			crayonBackgroundImage.onload = resourceLoaded;
			crayonBackgroundImage.src = "bower_components/mx-drawing/images/crayon-background.png";

			markerBackgroundImage.onload = resourceLoaded;
			markerBackgroundImage.src = "bower_components/mx-drawing/images/marker-background.png";

			eraserBackgroundImage.onload = resourceLoaded;
			eraserBackgroundImage.src = "bower_components/mx-drawing/images/eraser-background.png";

			crayonTextureImage.onload = resourceLoaded;
			crayonTextureImage.src = "bower_components/mx-drawing/images/crayon-texture.png";
		};
